...
export function ConfigContent({ initialConfig }: ConfigContentProps) {
    ...
    setConfig((prev) =>
      prev
        ? {
            ...
            logoPublicId: data.imagePublicId ?? prev.logoPublicId,
          }
        : prev
    );
  ...
  const addCustomUnit = () => {
    ...
    const id = newUnit.name
      .toLowerCase()
      .replace(/\s+/g, '_')
      .replace(/[^a-z0-9_]/g, '');
    if (
      config.customUnits.some((cu) => cu.id === id) ||
      ['unidad', 'kilo', 'litro'].includes(id)
    ) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta información se mostrará en el catálogo, PDFs y documentos
              generados
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={config.taxId}
                onChange={(e) =>
                  setConfig({ ...config, taxId: e.target.value })
                }
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Activa o desactiva funcionalidades adicionales según las
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configura qué unidades están disponibles para tus productos.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={newUnit.short}
                    onChange={(e) =>
                      setNewUnit({ ...newUnit, short: e.target.value })
                    }
                    placeholder="Ej: doc"
                  />
                </div>
