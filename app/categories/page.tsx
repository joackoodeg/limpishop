  ...
  return (
    <div>
      <PageHeader
        ...
        actions={[
          { label: 'Asignar Productos', href: '/categories/assign', variant: 'secondary' },
        ]}
      />
      ...
      <Card className="mb-6">
        <CardContent className="pt-6">
          <h2 className="text-lg font-semibold mb-4">{editingCategory ? 'Editar Categoría' : 'Nueva Categoría'}</h2>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Crea tu primera categoría usando el formulario de arriba</p>
            </div>
          </CardContent>
        </Card>
      ) : (
              ...
              <CardContent className="pt-4">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-start gap-4 flex-1">
                    <CategoryImage category={category} width={80} height={80} className="flex-shrink-0 rounded-lg" />
                    <div>
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    <Button size="sm" variant="outline" onClick={() => toggleImageUpload(category.id)}>
                      ...
                      <span className="hidden sm:inline ml-1">{category.imageUrl ? 'Cambiar img' : 'Imagen'}</span>
                    </Button>
