...
export default function EditComboPage() {
    ...
    useEffect(() => {
        ...
        // Solo recalcular precio final automáticamente si el descuento cambia
        // No cuando se está cargando data inicial
        if (!fetchingData && formData.discountPercentage >= 0) {
    ...
    }, [comboProducts, formData.discountPercentage, fetchingData]);
    ...
    if (fetchingData) {
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="text-center">Cargando datos del combo...</div>
            </div>
        );
    }
                        ...
                        <div className="mt-4">
                            <label className="flex items-center">
                                <input
                                    ...
                                    className="mr-2"
                                />
                                <span className="text-sm font-medium text-gray-700">Combo activo</span>
                            </label>
                        </div>
                    </div>
